#
# ModifiedCopyOfCertSetup.ps1
#
# Marked with #JEO these 3 mods create Subject Alternative Name entries
# as DNS entries; use this instead of the CertSetup.ps1 script in the
# C:\Program Files\Microsoft SDKs\Service Fabric\ClusterSetup\Secure
...
(
	...
	#JEO Begin modification 0
	[Parameter(Mandatory=$False)]
    [string] $CertDnsName = "yourCluster.yourAzureRegion.cloudapp.azure.com"
	#JEO End modification 0
)
...
if($Install)
{
	...
	#JEO Begin modification 1
	$AltNameType = @{
    DNS_NAME = 3 # A Domain Name System (DNS) name such as MyDomain.Microsoft.com.
    }
	$altNamesCollection = new-object -com "X509Enrollment.CAlternativeNames"
	$extNames = new-object -com  "X509Enrollment.CX509ExtensionAlternativeNames"
	$altDnsName = new-object -com "X509Enrollment.CAlternativeName"
	$altDnsName.InitializeFromString($AltNameType.DNS_NAME, $CertDnsName)
	$altNamesCollection.Add($altDnsName)
	$extNames.InitializeEncode($altNamesCollection)
	#JEO End modification 1
	...
	#JEO Begin modification 2
	$Cert.X509Extensions.Add($extNames)
	#JEO End modification 2
...
# bAegghhTMIIEwjCCA6qgAwIBAgITMwAAALu2dyRxSiAAIAAAAAAAuzANBgkqhkiG
...
# MDMwMjIzMzY0MlowIwYJKoZIhvcNAQkEMRYEFGi+c0cSLq+6+sU3ivaeBlULQx4U
# MA0GCSqGSIb3DQEBBQUABIIBAGBZHOi31MD70vOFd8sH/5OA27nUewRctuJtRkj+
# zKgUcMsIrBn+iE1aMfqhiRCJNFqFKt6ocguOcImkOD7Vc8YjSM+RPlrYIoMZg3rU
# b7qqbCT+9OxReiEdHGx23HuE/UqYW4lYxP2Mb7HS7v0dPyCXAnmkbvczdm3cZ+Oh
# qEasycTCfBUrdJMAyDyj+wP7tfxLZ1upedJhd2Ti9a/LiP8i3rO0msgzgENFAm2Z
# 1ANTL090/MAqyTRX8VuZLH58M64R7JLaDNqR0mxzoFJwVC23fxiRwyom0/EApQbS
# AlH2/RY+9FCsOxTFfWpm2bwtK6hdW66rPVTaYj2qh+SQMiU=
